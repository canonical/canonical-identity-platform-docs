<a id="get-started-with-canonical-identity-access-proxy"></a>
...
The solution is based on open source products from [Ory](https://www.ory.sh/open-source/), [Traefik Labs](https://traefik.io/), 
and [OAuth2 Proxy](https://oauth2-proxy.github.io/oauth2-proxy/) - a Cloud Native Computing Foundation (CNCF) Sandbox project.
...
between the Identity Platform's OIDC provider ([Ory Hydra](https://www.ory.com/hydra)) and your ingress controller,
...
- MinIO Kubernetes Plugin enabled. See more: [Enable MinIO plugin on Microk8s](https://microk8s.io/docs/addon-minio)
...
The `iam` model contains all the crucial identity applications, as explained in the [Canonical Identity Platform architecture](/t/11913) guide.
...
> Learn how to set up external identity providers in [this guide](/t/11910).
...
> You can run [this script](https://raw.githubusercontent.com/canonical/spark-history-server-k8s-operator/8a9f663eab64808af8871f3c77d0405aad9459a9/tests/integration/setup/setup_minio.sh) to retrieve them.
...
```commandline
juju run traefik-public/0 show-proxied-endpoints --format json | \
