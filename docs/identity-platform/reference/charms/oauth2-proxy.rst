...
* `Contribute on GitHub <https://github.com/canonical/oauth2-proxy-k8s-operator>`_

Thinking about using OAuth2 Proxy for your next project? `Get in touch <https://matrix.to/#/!3xNKp3PFtjTOKbwJykMRzruCbSEMkXb8ZRrDKk1vknI?via=ubuntu.com>`_ with the team!
