.. _manage-external-identity-providers:
...
.. note::
    ...
    See the full list of identity providers you can integrate with `here <https://www.ory.sh/docs/kratos/social-signin/generic>`_.
...
.. note::
    See more: `Microsoft | Azure > Register a new application <https://learn.microsoft.com/en-us/azure/healthcare-apis/register-application#register-a-new-application>`_
...
.. note::
    See more: `Microsoft | Azure > How to find a tenant <https://learn.microsoft.com/en-us/azure/active-directory/fundamentals/how-to-find-tenant>`_
...
To create a confidential client in GitHub, go to developer settings and `register a new GitHub application <https://github.com/settings/applications/new>`_,
...
Then we need to configure the integrator charm. Depending on the provider that we use, a different set of configurations is needed. A list of instructions for some of the most common providers can be seen below. Please refer to the `integrator charm <https://charmhub.io/kratos-external-idp-integrator>`_ and the `Kratos documentation <https://www.ory.sh/docs/kratos/social-signin/overview>`_ for further details.
