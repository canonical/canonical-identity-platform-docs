...
.. image:: https://raw.githubusercontent.com/canonical/canonical-identity-platform-docs/main/Diagram_sources/authentik-tutorial-topology.png
...
Navigate to the tutorial directory in the server operator repository:
...
* Proceed to :doc:`Protect OIDC and OAuth applications </how-to/authentik/protect-oidc-applications>` to configure Single Sign-On (SSO).
* Proceed to :doc:`Protect LDAP applications </how-to/authentik/protect-ldap-applications>` to connect directory services.
