...
* Learn how to :doc:`Protect OIDC and OAuth applications <protect-oidc-applications>` to enable SSO integrations.
* Learn how to :doc:`Protect LDAP applications <protect-ldap-applications>` to integrate directory consumers.
