...
1. **Action Credential Exposure (Accepted Risk L-4)**:
...
5. **Container Process Credential Access**:
...
6. **Web UI Login for Bind Accounts**:
...
7. **Cached Bind and Search Propagation Delay**:
