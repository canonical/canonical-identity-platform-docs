.. meta::
    :description: Step-by-step guides covering key operations and common tasks for the Identity Platform.
...
-------------------------
Perform administrative tasks to manage users, roles, and security settings.

* :doc:`Manage users <manage-users>`
* :doc:`Link social or enterprise accounts <link-social-accounts>`
